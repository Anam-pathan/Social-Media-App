  ...
  return (
    <form className="create-post" onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        ...
        <input type="text" ref={reactionsElement} className="form-control" id="reactions" placeholder="How many reacted to this post?"/>
        
      </div>

      <div className="mb-3">
        <label htmlFor="reactions"  className="form-label">Enter HashTags</label>
        <input type="text" ref={tagsElement} className="form-control" id="reactions" placeholder="Enter your tags here"/>
